...
export default function CategoryOrArticleView({ 
  ...
  const convertToNewsCardFormat = (articleData: Post) => ({
    ...
    featuredImage: articleData.thumbnail || undefined,
    category: { 
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 mb-2">
                          Đây là một bình luận mẫu cho bài viết này. Nội dung rất hữu ích và thông tin.
                        </p>
        ...
        <div className="lg:col-span-3">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              {category?.metaDescription || `Tin tức mới nhất về ${category?.name || params.category}`}
            </p>
            ...
            {articles.length > 0 ? (
              ...
              [1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <NewsCard 
                  ...
                  post={{
                    id: i.toString(),
                    title: `${category?.name || params.category} tin tức số ${i}`,
